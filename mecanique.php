...
echo '<h3 class="text-primary">Vous avez selectionne precedemment : '.$_SESSION['nom_tech'].' -> '.$_SESSION['machine'].' -> '.$_SESSION['mecanique'].' <br /></h3> ';
}
...
while($data = mysql_fetch_array($req)) 
    ...
    echo '<input type="submit" name="traitement3" class="btn btn-primary btn-lg btn-block" value="'.$data['Traitement3'].'"/>'; 
    } 
