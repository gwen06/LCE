...
echo '<h3 class="text-primary">Vous avez selectionne precedemment : '.$_SESSION['nom_tech'].' -> '.$_SESSION['machine'].' -> '.$_SESSION['technique2'].' <br /></h3> ';
}
...
while($data = mysql_fetch_array($req)) 
    ...
    echo '<input type="submit" name="traitement5" class="btn btn-primary btn-lg btn-block" value="'.$data['traitement5'].'"/>';
    } 
